        ...
        <fieldset class="!mt-0 InputGroup" v-for="(field, idx) in fields" :key="field.key">
          <div class="relative grid grid-cols-12 gap-4 pr-6 py-6"
            ...
            <BaseSelect class="col-span-2" :nameModel="`dependent[${idx}].dependentTypes`" :listItens="dependentTypes"
              label="Tipo" />
            <BaseInput class="col-span-4" :name="`dependent[${idx}].name`" type="text" label="Nome" :value="field.value.name" />
            ...
            <BaseInput class="col-span-3" :name="`dependent[${idx}].numberRg`" type="text" label="Número do RG" :value="field.value.numberRg" />
            ...
            <BaseInput class="col-span-2" :name="`dependent[${idx}].expeditionUf`" type="text" label="UF expedição" :value="field.value.expeditionUf" />
            <BaseInput class="col-span-2" :name="`dependent[${idx}].expeditionAgency`" type="text"
